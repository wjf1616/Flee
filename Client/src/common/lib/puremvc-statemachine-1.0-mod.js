...
function StateMachine() {
    cc.GamePureMVC.Mediator.call(this, StateMachine.NAME, null);
    this.states = {};
}
    
StateMachine.prototype = new cc.GamePureMVC.Mediator;
...
function FSMInjector(fsm) {
    cc.GamePureMVC.Notifier.call(this);
    this.fsm = fsm;
}
  
FSMInjector.prototype = new cc.GamePureMVC.Notifier;
...
FSMInjector.prototype.inject = function() {
    ...
    var stateMachine = new cc.GamePureMVC.statemachine.StateMachine();
...
FSMInjector.prototype.createState = function(stateDef) {
    ...
    var state = new cc.GamePureMVC.statemachine.State(name, entering, exiting, changed);
